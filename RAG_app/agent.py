...
class DatastoreService:
    ...
    def search_datastore(self, project_id, location, datastore_id, query):
        ...
        url = f"https://{location}-discoveryengine.googleapis.com/v1alpha/projects/{project_id}/locations/{location}/collections/default_collection/dataStores/{datastore_id}/servingConfigs/default_search:answer"
